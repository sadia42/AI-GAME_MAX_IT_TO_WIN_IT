...
#----------------------------------------If HUMAN MOVES FIRST--------------------------------------------
       ...
       if choice == 2:   
          ...
          for i in range(lo, hi+1):
            ...
            #print(test[i])
            btn = tk.Button(window, text=test[i], height=1, width=8, command=lambda lastPressed = lastPressed , press = i:show_press(press, lastPressed))
            btn.pack()
            lastPressed += 1
            buttons.append(btn)
          ...
          passBtn = Button(window, text=' PASS', fg='black', bg='#66ff33', height=2, width=9, command= lambda: passval(passBtn ))
